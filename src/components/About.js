...
const ServiceCard = function({ index, title, icon }) {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('img', { src: icon, alt: title, className: 'w-16 h-16 object-contain' }),
        React.createElement(
          'h3',
          {
            className: 'text-white text-[20px] font-bold text-center',
            style: { fontFamily: 'Dreaming Outloud Pro' }
          },
          title
        )
      )
...
const About = function() {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'h3',
        { className: 'text-white font-extrabold text-[50px]' },
        'Overview.'
      )
    ),
    React.createElement(
    ...
    React.createElement(
      ...
      services.map(function(service, index) {
        return React.createElement(ServiceCard, { key: service.title, index: index, ...service });
      })
    )
  );
};
