...
const Contact = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('p', { className: `${styles.sectionSubText} mb-4` }, 'It was nice to meet you, Nice to meet me?'),
      React.createElement('h3', { className: 'text-white font-extrabold text-[30px]' }, 'Contact me from anywhere on the globe.'),
      React.createElement(
        'form',
        {
          ref: formRef,
        ...
        React.createElement(
          ...
          React.createElement('span', { className: 'text-white font-medium mb-4' }, 'Your Name'),
        ...
        React.createElement(
          'label',
          { className: 'flex flex-col' },
          React.createElement('span', { className: 'text-white font-medium mb-4' }, 'Your Email Address'),
          React.createElement('input', {
            type: 'email',
            name: 'email',
            value: form.email,
        ...
        React.createElement(
          'label',
          { className: 'flex flex-col' },
          React.createElement('span', { className: 'text-white font-medium mb-4' }, "What's on your mind?"),
    ...
    React.createElement(
      ...
      React.createElement(EarthCanvas, null)
    )
  );
};
